...
class ListLite extends Component {
  ...
  onLoad(data, offset) {
    ...
    if (this.ctx.conf.versionCheck && this.versionCheck("\u524D\u7AEF", feMinVersion, "2.2.4"))
      return;
...
class List extends ListLite {
  constructor(ctx) {
    ...
    this.$el.querySelector(".atk-copyright").innerHTML = `Powered By <a href="https://artalk.js.org" target="_blank" title="Artalk v${"2.2.4"}">Artalk</a>`;
